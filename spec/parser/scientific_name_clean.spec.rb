...
describe ScientificNameClean do
  ...
  it 'should parse scientific name' do
    ...
    details("Tuber liui A S. Xu 1999").should == {:genus=>"Tuber", :species=>"liui", :authors=>{:names=>["A S. Xu"], :year=>"1999"}}
    parse('Xylaria potentillae A S. Xu').should_not be_nil
  ...
  it 'should parse names with taxon concept sec. part' do
    ...
    details('Sténométope laevissimus sec. Eschmeyer 2004').should == {:genus=>"Sténométope", :species=>"laevissimus", :taxon_concept=>{:authors=>{:names=>["Eschmeyer"], :year=>"2004"}}}
    parse("Sténométope laevissimus Bibron 1855 sec. Eschmeyer 2004").should_not be_nil
    details('Sténométope laevissimus Bibron 1855 sec. Eschmeyer 2004').should == {:genus=>"Sténométope", :species=>"laevissimus", :authors=>{:names=>["Bibron"], :year=>"1855"}, :taxon_concept=>{:authors=>{:names=>["Eschmeyer"], :year=>"2004"}}}
    # 
    # puts "<pre>"
